...
public class BulletSingle implements InterfaceSprite {
	...
	public void onLoadResources(Engine mEngine, Context mContext) {
		...
		this.bulletTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(bulletBitmapTextureAtlas, mContext,"dan1.png", 0, 0, 4, 1);
	...
	public void setStatusBullet(int statusbullet) {
		BulletSingle.this.STATUS_BULLET = statusbullet;
	}

	public int getStatusBullet() {
		return BulletSingle.this.STATUS_BULLET;
	}
	...
	public void setPositionX(float pX) {
		BulletSingle.this.pX = pX;
	}

	public float getPositionX() {
		return BulletSingle.this.pX;
	}

	public void setPositionY(float pY) {
		BulletSingle.this.pY = pY;
	}

	public float getPositionY() {
		return BulletSingle.this.pY;
	}
